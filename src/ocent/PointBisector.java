...
public class PointBisector implements ISiteBisector {
  ...
  public void clipPair(Hyperbola hij, Hyperbola hik, EdPoint commonSite,
      DArray iPts) {
    clipPair(hij, hik, commonSite, iPts, false);
  }

  public void clipPair(Hyperbola hij, Hyperbola hik, EdPoint commonSite,
      DArray iPts, boolean farthest) {
    ...
    case 0:
...

      {
        ...
        farthest
            ...
            FPoint2.distanceSquared(origin, pi) < FPoint2.distanceSquared(
                origin, pj)) {
          if (db) {
